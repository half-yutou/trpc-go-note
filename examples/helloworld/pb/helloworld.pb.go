...
const file_helloworld_proto_rawDesc = "" +
	"\n" +
	"\x10helloworld.proto\x12\x0ftrpc.helloworld\" \n" +
	...
	"\aGreeter\x12E\n" +
	"\x05Hello\x12\x1d.trpc.helloworld.HelloRequest\x1a\x1b.trpc.helloworld.HelloReply\"\x00B%Z#trpc-go-note/examples/helloworld/pbb\x06proto3"
